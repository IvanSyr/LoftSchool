...
function skipDefault(eventName, target) {
    function onEventDefault (e) {
        e.preventDefault();
    }
  
    target.addEventListener(eventName, onEventDefault);
}
...
function once(target, fn) {
    function onOnce (e) {
        fn();
        e.target.removeEventListener('click', onOnce);
    }

    target.addEventListener('click', onOnce);
}
